...
insert into categoria (nome) values ('rrrrrrrrrrrrrrrrrrrrr');
insert into categoria (nome) values ('hhhhhhhhhhhhhhhhhhhh');
insert into categoria (nome) values ("egeregreg");
insert into categoria (nome) values ('iuaohiuwheifuhawie');
insert into categoria (nome) values ('wgasstgsrtsrhsr');
insert into categoria (nome) values ('wegrwergwergwer');
insert into categoria (nome) values ('AWDASD');
insert into categoria (nome) values ('wererth');
insert into categoria (nome) values ('teteeryretyertyer');
insert into categoria (nome) values ('dhdtydjdtyjtdyjtd');
insert into categoria (nome) values ('jtyryjrtyjrtyjjrt');
...
insert into contato (nome) values ('hreheyjtryjrtyjt');
insert into contato (nome) values ('jtjrtjrtyjrtyjrtyryj');
insert into contato (nome) values ('zzzzzz');
insert into contato (nome) values ('aaaaaa');
insert into contato (nome) values ('eeeeeeeeeeeeeeeeeeeeeeeee');
insert into contato (nome) values ('rrrrrrrrrrrrrrrrrrrrr');
insert into contato (nome) values ('hhhhhhhhhhhhhhhhhhhh');
insert into contato (nome) values ("egeregreg");
insert into contato (nome) values ('iuaohiuwheifuhawie');
insert into contato (nome) values ('wgasstgsrtsrhsr');
