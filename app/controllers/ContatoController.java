...
//        }
    ...
    public static Result buscaPorNome(String nome) {
        ...
        String username = session().get("email");
        Query<Contato> query = Ebean.createQuery(Contato.class, "find contato where (nome like :nome or email like :emailContato) and dono.email = :email");
        query.setParameter("email", username);
        query.setParameter("nome", "%" + nome + "%");
        query.setParameter("emailContato", "%" + nome + "%");
